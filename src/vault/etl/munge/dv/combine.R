...
air.daymet <- read_feather("data/munged/dv/air/temp_only__daymet_compiled.feather")
wtr.usgs <- read_feather("data/munged/dv/wtr/temp_only_usgs_compiled.feather")
...
write_feather(air.wtr, "data/munged/dv/combined/temp_only__air_wtr.feather")
